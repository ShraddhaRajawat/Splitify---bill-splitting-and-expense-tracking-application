...
export const getGroupExpenses = query({
  ...
  handler: async (ctx, { groupId }) => {
    ...
    /* ----------  ledgers ---------- */
    // balance coalculation setup
    // total net balance (old behaviour)
    // initialize total object to track overall balanace for each user
    // format : {userID1: balance1, userID2 : balance2}
    const totals = Object.fromEntries(ids.map((id) => [id, 0]));
    // pair‑wise ledger  debtor -> creditor -> 
    //create  a 2-d ledger to track who owes whom
    ...
    /* ----------  apply expenses ---------- */
    // example:
    // - expense 1: user1 paid $60, split equally among all 3 user($20 each)
    // - after applying this expenses:
    ...
    // }
    // this means user2,user3 owes user1 20 
    ...
    /* ----------  apply settlements ---------- */
    // example:
    // - settlements 1: user2 paid $10
    // - after applying this settlements:
    ...
    //     "user3":{"user1" : 20, "user2" : 0}
    // }
    // this means user2 owes user1 $10,user3 owes user1 $20 
